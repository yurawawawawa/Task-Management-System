      ...
      <div className="w-full max-w-[400px] px-6">
        <div className="flex justify-center mb-8">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-8 h-8 bg-black text-white rounded-lg flex items-center justify-center font-bold text-lg shadow-sm">
              T
            </div>
            <span className="text-2xl font-bold tracking-tight text-black">Taskora</span>
          </Link>
        </div>

        <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-200">
          {children}
        </div>
      </div>
