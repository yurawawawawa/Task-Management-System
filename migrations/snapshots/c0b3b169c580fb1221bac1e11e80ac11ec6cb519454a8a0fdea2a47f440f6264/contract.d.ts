...
export type StorageHash =
  StorageHashBase<'c0b3b169c580fb1221bac1e11e80ac11ec6cb519454a8a0fdea2a47f440f6264'>;
export type ExecutionHash =
  ExecutionHashBase<'cad9bd0a70e244b731e4dda55899ed4b60ec6aed0af979cfffeb63a19bf38d95'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly DailyActivity: {
      ...
      readonly taskCount: CodecTypes['pg/int4@1']['output'];
      readonly streakCounted: CodecTypes['pg/bool@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly DailyActivity: {
      ...
      readonly taskCount: CodecTypes['pg/int4@1']['input'];
      readonly streakCounted: CodecTypes['pg/bool@1']['input'];
...
export type StorageColumnTypes = {
  readonly public: {
    readonly daily_activities: {
      ...
      readonly date: CodecTypes['pg/text@1']['output'];
      readonly id: CodecTypes['pg/uuid@1']['output'];
      readonly streak_counted: CodecTypes['pg/bool@1']['output'];
      readonly task_count: CodecTypes['pg/int4@1']['output'];
...
export type StorageColumnInputTypes = {
  readonly public: {
    readonly daily_activities: {
      ...
      readonly date: CodecTypes['pg/text@1']['input'];
      readonly id: CodecTypes['pg/uuid@1']['input'];
      readonly streak_counted: CodecTypes['pg/bool@1']['input'];
      readonly task_count: CodecTypes['pg/int4@1']['input'];
...
export namespace Models {
  export type public_Profile = {
    ...
    dailyActivities: public_DailyActivity[];
    projectMembers: public_ProjectMember[];
    projects: public_Project[];
    tasks: public_Task[];
    readonly [RelationKeys]?:
      'assignedTasks' | 'dailyActivities' | 'projectMembers' | 'projects' | 'tasks';
  };
  ...
  export type public_DailyActivity = {
    id: CodecTypes['pg/uuid@1']['output'];
    userId: CodecTypes['pg/uuid@1']['output'];
    date: CodecTypes['pg/text@1']['output'];
    taskCount: CodecTypes['pg/int4@1']['output'];
    streakCounted: CodecTypes['pg/bool@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    user: public_Profile;
        ...
        readonly entries: {
          readonly table: {
            readonly daily_activities: {
              ...
              indexes: readonly [
                {
                  readonly name: 'daily_activities_user_id_idx_6c952402';
                  readonly prefix: 'daily_activities_user_id_idx';
                  readonly columns: readonly ['user_id'];
                  readonly unique: false;
                },
                {
                  readonly name: 'daily_activities_user_id_date_idx_ad901aac';
                  readonly prefix: 'daily_activities_user_id_date_idx';
                  readonly columns: readonly ['user_id', 'date'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    ...
                    readonly tableName: 'daily_activities';
                    readonly columns: readonly ['user_id'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
      ...
      readonly public: {
        readonly models: {
          readonly DailyActivity: {
            ...
            readonly storage: {
              readonly table: 'daily_activities';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'user_id' };
                readonly date: { readonly column: 'date' };
                readonly taskCount: { readonly column: 'task_count' };
                readonly streakCounted: { readonly column: 'streak_counted' };
